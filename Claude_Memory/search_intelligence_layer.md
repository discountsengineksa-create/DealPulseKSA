...
description: بحث الموقع صار ٤ طبقات (تطبيع عربي + search_concepts + blog_bridge) — حيّ على الإنتاج ٢٠٢٦-٠٨-٣٠؛ /coupons/search أعيد كتابته، migration_070 شُغّلت، blog_bridge ١٤٠٧ صفّ
metadata: 
  node_type: memory
  type: project
  originSessionId: af5f88b2-ef39-4521-add3-b8b3d0c591c9
  modified: 2026-08-30T15:58:25.503Z
---
...
**الحالة ٢٠٢٦-٠٨-٣٠:** الكود مدفوع للريبوين، `migration_070` شُغّلت على الإنتاج
(٣٢٧ concept / ٤٢ وسماً / `normalize_ar()`)، و`blog_bridge` مملوء (١٤٠٧ مقال، ٥٩
متجراً). مثبَّت حيّاً: `أحذية`→٨ متاجر أحذية، `فحمات`→متاجر سيارات + علي اكسبرس
via مقال، `نمشى`→نمشي.

**ملاحظة ترتيب:** التدرّج يرتّب داخله بـ`popularity_score` — فـ`نون` (marketplace،
شعبية ٢٧، موسوم سيارات) يتصدّر `فحمات` قبل متاجر قطع الغيار المتخصّصة. مقبول v1؛
عقوبة لوسوم الـmarketplace تحسين لاحق.
