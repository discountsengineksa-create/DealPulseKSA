...
> ١٤٠ ملفاً (عُدّت ٢٠٢٦-٠٨-١٣ بعد إضافة فلتر النصائح الخارجية — الرقم يطابق القرص، وصفر فرق في الاتجاهين). **العدّ للمتون، بلا `MEMORY.md` نفسه** (`ls *.md` يعطي ١٤١ — لا تنسخه هنا). **الفهرس وحده يُحمَّل — المتون لا.** السطر هنا **عنوان لا حقيقة**؛ الحقيقة في المتن.
