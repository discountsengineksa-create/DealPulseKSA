...
> ١٤١ ملفاً (عُدّت ٢٠٢٦-٠٨-١٧ بعد إضافة تطبيق الهوية — الرقم يطابق القرص، وصفر فرق في الاتجاهين). **العدّ للمتون، بلا `MEMORY.md` نفسه** (`ls *.md` يعطي ١٤٢ — لا تنسخه هنا). **الفهرس وحده يُحمَّل — المتون لا.** السطر هنا **عنوان لا حقيقة**؛ الحقيقة في المتن.
