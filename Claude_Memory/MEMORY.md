...
> ١٧٤ ملفاً (عُدّت ٢٠٢٦-٠٩-١١ بعد عنقود بتيل — `ls *.md | grep -v MEMORY.md | wc -l` = ١٧٤). **العدّ للمتون، بلا `MEMORY.md` نفسه**. **الفهرس وحده يُحمَّل — المتون لا.** السطر هنا **عنوان لا حقيقة**؛ الحقيقة في المتن.
