...
- [🍼 عنقود ممزورلد (حمل وأمومة ومواليد وأطفال)](blog_mumzworld_cluster.md) — **٢٠ مقالاً** `mumzworld-` (web `2b36d8d`)؛ `master.id=93` كود **M43** خصم ١٠٪؛ طلب المالك صريح: أمهات جدد + Q&A + وسائد الحمل + جداول؛ نفس انضباط YMYL/السلامة كالنهدي (لا فورمولا، لا مقاعد سيارة، لا مصدّات سرير) + تمييز وسائد الحمل الآمنة عن مصدّات الرضيع؛ de-orphan في ٤ هَبّات محايدة، **لم تُمسّ عناقيد ماماز آند باباز الشريكة**؛ كود شخصي (`DISCOK95` إحالة ٢٥٪) وُجد بحساب المالك ولم يُنشَر — استُخدم M43 فقط
