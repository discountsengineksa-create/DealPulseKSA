...
> ١٦٦ ملفاً (عُدّت ٢٠٢٦-٠٩-١٠ بعد عنقود ذي بيوتي سيكرتس — `ls *.md | grep -v MEMORY.md | wc -l` = ١٦٦). **العدّ للمتون، بلا `MEMORY.md` نفسه**. **الفهرس وحده يُحمَّل — المتون لا.** السطر هنا **عنوان لا حقيقة**؛ الحقيقة في المتن.
