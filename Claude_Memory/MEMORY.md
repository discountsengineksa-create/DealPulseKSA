...
- [🪵 عنقود الدخيل للعود](blog_aldakheel_cluster.md) — ١٦ مقالاً `aldakheel-` (web `15a3d29`)؛ `master.id=83` كود HH14 خصم ٥٪ إضافي بوستيني؛ زاوية بيت عطور تجاري+معطّرات منزل+توزيعات؛ طلب كوبون سعودي حقيقي؛ `blog_bridge` ١٥٣٠/٦٨ معلّق
- [🍽️ عنقود نايس (NICE هوم-وير)](blog_nice_cluster.md) — ١٦ مقالاً `nice-` (web `8003e79`)؛ `master.id=84` كود E13 خصم ١٠٪ يشمل المخفّض بوستيني؛ **⚠️ «نايس» ≠ «نايس ون»** (تلوّث SERP، أُفصح في كل مقال)؛ زاوية خاصّة بالمتجر (دلتي + مجموعات تصميم) لا تعليم فئات؛ `blog_bridge` ١٥٤٥/٦٩ معلّق
