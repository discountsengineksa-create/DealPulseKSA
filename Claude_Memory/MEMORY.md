...
> ١٤٢ ملفاً (عُدّت ٢٠٢٦-٠٨-١٨ بعد إضافة سكربت الزيارة الميدانية — الرقم يطابق القرص، وصفر فرق في الاتجاهين). **العدّ للمتون، بلا `MEMORY.md` نفسه** (`ls *.md` يعطي ١٤٣ — لا تنسخه هنا). **الفهرس وحده يُحمَّل — المتون لا.** السطر هنا **عنوان لا حقيقة**؛ الحقيقة في المتن.
...
- [🚪 سكربت الزيارة الميدانية](field_visit_script.md) — الاستقبال يُنتج **اسماً لا اجتماعاً** (سقف معلَن)؛ والدقيقة الأولى تفتح بصفحة الدفع عندهم لا بالمنصّة؛ «أخذ الكود = نيّة شراء مؤكّدة» تقلب التصنيف
