...
> ١٧٢ ملفاً (عُدّت ٢٠٢٦-٠٩-١١ بعد عنقود ناتشورال تاتش — `ls *.md | grep -v MEMORY.md | wc -l` = ١٧٢). **العدّ للمتون، بلا `MEMORY.md` نفسه**. **الفهرس وحده يُحمَّل — المتون لا.** السطر هنا **عنوان لا حقيقة**؛ الحقيقة في المتن.
