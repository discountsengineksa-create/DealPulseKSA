...
- [💊 عنقود صيدلية النهدي أونلاين](blog_nahdi_cluster.md) — **٢٠ مقالاً** `nahdi-` (web `c3934c7`)؛ `master.id=91` كود **9LDF** خصم ٥٪ (حد ٢٥ ريال، عملاء جدد، **يستثني الأدوية وحليب الأطفال**)؛ منضبط YMYL (لا فورمولا رضّع، لا مكمّلات حمل/أمراض مزمنة، لا مقاعد سيارة، لا «الصحة الجنسية»)؛ de-orphan في ٥ هَبّات جمال/فيتامينات؛ ⚠️ `my_coupon='6%'` مغلوط · `blog_bridge` معلّقان
