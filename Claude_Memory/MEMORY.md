...
- [📈 GA4 رُكِّب — ويعتمد على مفتاح بلوحة التحكّم](web_ga4_install.md) — `G-VRBHD0VK66` حيّ على ٦ مسارات؛ **لا `page_view` يدويّ فالقياس المحسّن هو من يرصد تنقّل Next — وكان مطفأً**؛ وCSP كانت ستحجبه بصمت
