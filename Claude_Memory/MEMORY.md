...
> ١٦٥ ملفاً (عُدّت ٢٠٢٦-٠٩-١٠ بعد عنقود بلوار — `ls *.md | grep -v MEMORY.md | wc -l` = ١٦٥). **العدّ للمتون، بلا `MEMORY.md` نفسه**. **الفهرس وحده يُحمَّل — المتون لا.** السطر هنا **عنوان لا حقيقة**؛ الحقيقة في المتن.
...
## ٦) المحتوى والمدوّنة (٢٦)

- [Voice Bible](voice_bible.md) — نموذج الصوت التحريري؛ قلّد العيّنة
- [Blog Total = Count It Live](blog_massive_content_session.md) — **١٨٧١ (عُدَّ ٢٠٢٦-٠٩-١٠ بعد عنقود بلوار)**؛ عُدّ بـ`grep -cE "^\s*slug:" lib/blog.ts` لا تجمع تقديرياً
