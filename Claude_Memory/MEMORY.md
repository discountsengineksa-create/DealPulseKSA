...
> ١٣٩ ملفاً (عُدّت ٢٠٢٦-٠٨-١٣ — الرقم يطابق القرص، وصفر فرق في الاتجاهين). **العدّ للمتون، بلا `MEMORY.md` نفسه** (`ls *.md` يعطي ١٤٠ — لا تنسخه هنا). **الفهرس وحده يُحمَّل — المتون لا.** السطر هنا **عنوان لا حقيقة**؛ الحقيقة في المتن.
