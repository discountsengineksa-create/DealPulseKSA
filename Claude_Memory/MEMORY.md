...
> ١٤٢ ملفاً (عُدّت ٢٠٢٦-٠٨-١٨ بعد إضافة مصادر تعلّم السيو — الرقم يطابق القرص، وصفر فرق في الاتجاهين). **العدّ للمتون، بلا `MEMORY.md` نفسه** (`ls *.md` يعطي ١٤٣ — لا تنسخه هنا). **الفهرس وحده يُحمَّل — المتون لا.** السطر هنا **عنوان لا حقيقة**؛ الحقيقة في المتن.
