...
> ١٤٨ ملفاً (عُدّت ٢٠٢٦-٠٨-٢٦ بعد ملف قصر الاواني — `ls *.md | grep -v MEMORY.md | wc -l` = ١٤٨، وفحص الاكتمال بالاتجاهين: صفر مفقود. الترويسة كانت تقول ١٤٦ والقرص ١٤٧ — فُرِّق فصُحِّح). **العدّ للمتون، بلا `MEMORY.md` نفسه** (`ls *.md` يعطي ١٤٩ — لا تنسخه هنا). **الفهرس وحده يُحمَّل — المتون لا.** السطر هنا **عنوان لا حقيقة**؛ الحقيقة في المتن.
