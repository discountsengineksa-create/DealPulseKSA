...
## 🔴 الوكلاء يموتون قبل الكتابة — والعلاج في البرومبت لا في الأداة

**قِيس ٢٠٢٦-٠٨-١٠ على تدقيق حقيقي:** ٧ وكلاء من ٧ انتهوا بـ**صفر ملفات** بعد **٥٤٤٬٣٨٢ توكن**
و٢١٠ استدعاء أداة. آخر جملة لكل واحد كانت «دعني أفحص…» لا خلاصة.

**السبب:** `maxTurns` بين **١٥ و٢٥** لكل وكيل (اقرأه من frontmatter في `agents/*.md`).
على موقع بـ١٧٤٨ صفحة، الاستقصاء يبتلع السقف فيموت الوكيل قبل خطوة الكتابة.

**العلاج — ثلاثة بنود في البرومبت، رفعت النجاح من ٠/٧ إلى ٩/٩:**

1. **ميزانية دورات صريحة:** «لك ١٥ دوراً، وسابقك مات عندها بلا ملف. استقصِ ٨ دورات ثم **اكتب**.
   تقرير ناقص مكتوب خير من كامل ضائع.»
2. **احقن كل ما قِيس مسبقاً** (أرقام، رؤوس، عيّنة روابط) — كل حقيقة تُعطى توفّر دورة.
3. **رتّب الأولويات** ليسلّم ناقصاً بدل أن يموت كاملاً.

الأثر: التوكن نزل من ~٧٨ ألفاً إلى ~٥٥ ألفاً للوكيل، والاستدعاءات من ~٣٠ إلى ٩–١٤.

⚠️ **ولا تصدّق أرقامهم.** ثلاثة أرقام محورية سقطت في التدقيق المضاد: فجوة العمق قيلت ٢٣٨×
وهي **٢٣×** (قِيس الطرفان بطريقتين مختلفتين)، ونطاق `no-store` قيل ١١٢ وهو **٩١**،
و«تناقض ذاكرة SaaSHub» لم يكن موجوداً أصلاً — الوكيل قرأ كلمة `dofollow` وافترضها لنا.
**عُدّ كل رقم محوري بأمر مستقل قبل البناء عليه** ([[feedback_mirror_audit]]).

🔴 **والخطأ الرابع ليس رقماً بل حكماً على الأعمال (٢٠٢٦-٠٨-١١):** صنّف `seo-sxo` متجر **«لحظات القهوة»**
بأنه **B2B لمكوّنات المشروبات** فأوصى بشطبه من الكتالوج — والحقيقة أنه متجر تجزئة عادي
بـ**طلبين و٣٦٥.٠٤ ر.س** في [[salla_proven_converters]]. رأى `coffeemoments.net` في السيرب
ونسب نموذج عمل الموقع للمتجر. ⇒ **لا تشطب أصلاً تجارياً على تصنيف وكيل — بياناتك الداخلية
(سلة/`action_logs`) تسبق أي سيرب.** التوصية سُحبت من `ACTION-PLAN.md` و`findings/sxo.md`.

💸 **١١ وكيلاً متوازياً استنفدوا نافذة الـ٥ ساعات على Pro** في جولة واحدة. شغّلهم على دفعات.
