...
modified: 2026-09-15T16:49:29.846Z
---
...
- ~~**الكاتب المعتمَد**~~ **[أُغلق جزئياً ٢٠٢٦-٠٩-١١، commit `1405fe3`]**: أُنشئ سجل كتّاب typed
  (`lib/authors.ts`) بنوعَين `person|team`، وصفحة `/author/[slug]` بـProfilePage+Organization/Person
  schema، وربطُ الـ٣٠ مقالاً بـ`authorSlug: founder`. القرار الفعلي بأمر المالك: `kind: team`
  باسم «فريق مقالات» بلا subtitle — الأقصر. الترقية لاحقاً لكاتب مُسمّى (محامٍ/محاسب) على مقالات
  YMYL تبقى **ثغرة مفتوحة** يفرضها playbook §٦ لكنها اختيار قابل للتأجيل حسب أولويات المالك.
...
## ⚠️ تحديث 2026-09-15 — الملف صار عنواناً لا حقيقة كاملة

جلسة أخرى (الجهاز الثاني) وسّعت العنقود لـ**٣٤ مقالاً** بعد ٢٠٢٦-٠٩-١١ بلا تحديث هذا الملف وبلا تطبيق قاعدة "صفر فبركة". ٨ من الإضافات فيها فبركة/أخطاء فعلية مؤكَّدة (أخطرها: تاريخ دمج PPA/GOSI قيل ٢٠١٧ والصحيح ٢٠٢١) — صُلِّحت ودُفعت بكوميت `9866880`. التفاصيل الكاملة والمنهجية: [[feedback_maqalat_government_cluster_fabrication_2026_09_15]]. **قبل الاستشهاد بأي عدد أو موضوع من هذا الملف كحقيقة حالية، تحقّق من الريبو الحيّ.**
