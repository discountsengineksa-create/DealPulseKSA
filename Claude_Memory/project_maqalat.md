...
## ⚠️ إلزامي أول كل جلسة (أضيف ٢٠٢٦-٠٩-١١)

المالك يقيس جودة هذه الجلسة مقابل جلسة نبض الصفقات على نفس الحساب — والحكم كان: تصميم/كود/كتابة
أضعف + توكن أعلى حتى بالوضع العادي. افتح هذين قبل أي مهمة:
- [[feedback_token_burn_control]] — سبب التضخّم الحقيقي مقيس (الصور لا الكود)، وحلّه ميكانيكي (جلسة لكل مهمة، لا لقطة لواجهة نصّية، Grep قبل Read)
- [[feedback_minimize_token_usage]] — عشر قواعد إلزامية صفرت الحشو بلا نزول جودة
- [[project_maqalat_writing_playbook]] قسم ١٠ (جديد) — تقنية العيّنة المشروحة، وأولوية الكاتب الموثَّق المفتوحة منذ عنقود الحكومة
