...
- ⚠️ **كود شخصي منفصل رآه المالك داخل حسابه:** صفحة «ادعي صديقة» بالموقع تعرض كوداً شخصياً (`DISCOK95` وقتها) بخصم **25%** لأول طلب + مكافأة 25 ريال للمُحيل — **هذا برنامج إحالة شخصي مربوط بحساب المالك، ليس كود M43 العلني في `master`**. لم يُستخدم في المحتوى (نشر كود شخصي باسم/حساب المالك علناً مخاطرة: قد يُحدَّ الاستخدام، وقد يُسحب). العنقود استخدم **M43** فقط (متّسق مع `master`)، ومقال الكود يشير لبرنامج الإحالة بشكل عام محايد بلا نشر الكود الشخصي نفسه.
