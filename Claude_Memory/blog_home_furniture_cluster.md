...
description: عنقود أثاث المنزل بمدوّنة الويب (نما لاحقاً إلى ~٤٥ مقالاً) — هَب + أدلّة تخصّصية بصوت خبير ٢٠ سنة. ⚠️ رُبط أصلاً بسيدار خطأً — سيدار لا يبيع أثاثاً إطلاقاً، صُحِّح ٢٠٢٦-٠٨-٢٨
metadata:
  type: project
...
- **المتاجر (بعد التصحيح):** **نون** (٥٪) هو المتجر المركزي للأثاث الفعلي (كنب/سرير/دولاب/سفرة/مكتب/خارجي — تحقّقت من فئات noon.com الحيّة)، يليه **بيتي شوب** (١٠٪، إكسسوارات وتنظيم) و**علي إكسبريس** (إكسسوارات فقط).
- **⚠️ سيدار — لا تربطه بالأثاث مرة أخرى:** كان "المتجر المركزي" الأصلي لهذا العنقود بادّعاء "متخصّص أثاث، تركيب+توصيل مجاني" — **فبركة كاملة**. راجعت خريطة موقع سيدار الحيّة (sedarglobal.com، ١.٧ ميجابايت كتالوج) 2026-08-28: **صفر** نتيجة لسرير/خزانة/مرتبة/كنب/wardrobe/mattress بأي لغة. سيدار = ستائر وبردورات (Blinds) وورق جدران وأبواب قابلة للطي وبيت ذكي (شراكة Somfy حقيقية) ومظلّات/براغولا خارجية فقط — يطابق تماماً `store_bio_en` الصحيح أصلاً بـ`master`. السبب الجذري: تاق سيدار الوحيد `{Home}` عام، وجلسة سابقة فسّرته "أثاث". **الدرس: لا تشتقّ كتالوج متجر من تاقه — تحقّق من الموقع الحيّ (خريطة الموقع/API) قبل ربط أي منتج بمتجر.** عنقود سيدار الصحيح والمنفصل موجود فعلاً (`sedar-curtains-guide-saudi` و١٤ شقيقاً) — راجعه لو احتجت محتوى سيدار الحقيقي.
