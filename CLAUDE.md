...
| ٩ | **لا حذف من الكتالوج ولا من المدوّنة** | **يُمنع حذف أي متجر أو مقال إلا بطلب شخصي صريح من المالك** (٢٠٢٦-٠٨-١١). لا استثناء لـ«صفر نقرة» ولا لتوصية وكيل/تدقيق. **التوصية مسموحة، التنفيذ ممنوع.** السبب: ٧٥٪ من استشهادات Copilot تأتي من صفحات بصفر نقرة في جوجل، ووكيل رشّح متجراً بطلبات حقيقية للشطب. → `feedback_never_delete_catalog_or_content.md` |
