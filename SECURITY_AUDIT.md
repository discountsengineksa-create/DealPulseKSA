...
| 12 | CSP (وضع التنفيذ) | ✅ **نُشِر ومُختبَر حيّاً** (دخول/OTP + صور + بيانات = بلا مشاكل) | متوسطة (إعلامية) |
...
**اختبار متصفّح حيّ (منجَز 2026-07-24):** المالك سجّل دخول عبر OTP بنجاح وحسابه/مفضلته/شعارات المتاجر تحمّلت كلها **بلا أي مشكلة** → CSP مؤكَّد لا يحجب Firebase/reCAPTCHA ولا API ولا Cloudinary. **الحماية مكتملة ومختبَرة.**
