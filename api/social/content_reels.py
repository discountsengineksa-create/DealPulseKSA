...
CONCEPTS: list[ContentConcept] = [
    ...
    {"kicker": "خطوات", "title": "كيف تستخدم كود الخصم خطوة بخطوة",
     ...
     "cta": "بسيطة ووفّرت"},
    {"kicker": "نصائح توفير", "title": "سرّ السعر اللي ينتهي بـ99 ريال",
     "points": ["عقلك يقرأ 99 أقرب لـ90 منه لـ100", "التجار يستغلّون هالحيلة النفسية", "قارن السعر الحقيقي لا الرقم المعروض"],
     "cta": "لا تنخدع بالأرقام — قارن دايم"},
    {"kicker": "نصائح توفير", "title": "حدّد ميزانية تسوّق وما تتعداها",
     "points": ["اكتب مبلغ شهري ثابت للتسوّق", "افصل الحاجة عن الرغبة", "استخدم الأكواد تشتري أكثر بنفس المبلغ"],
     "cta": "وفّر بذكاء مع نبض الصفقات"},
    {"kicker": "نصائح توفير", "title": "وش هو الكاش باك وكيف يوفّر لك",
     "points": ["جزء من مبلغ شرائك يرجع لك", "بعض المتاجر تعطيه ككود أو رصيد", "يضاعف توفيرك فوق خصم الكوبون"],
     "cta": "دوّر أكواد الكاش باك معنا"},
    {"kicker": "مواسم", "title": "رمضان — متى تشتري قبل رفع الأسعار",
     "points": ["اشترِ احتياجك قبل دخول الشهر", "راقب أسعار التمور والمكسّرات مبكراً", "احذر العروض الوهمية وقت الذروة"],
     "cta": "جهّز رمضانك بتوفير"},
    {"kicker": "مواسم", "title": "العودة للمدارس — قائمة التوفير",
     "points": ["جهّز قائمة قبل لا تشتري", "قارن أسعار القرطاسية والأجهزة", "استخدم أكواد المتاجر الكبيرة"],
     "cta": "وفّر بموسم المدارس معنا"},
    {"kicker": "تفاعل", "title": "كم كود جرّبت اليوم لين اشتغل واحد",
     "points": ["واحد؟ ولا خمسة؟ ولا استسلمت", "أسوأ شي تجرّب كود تلو الآخر", "خلّنا نجرّبها بدالك"],
     "cta": "قول رقمك بالتعليقات"},
    {"kicker": "تفاعل", "title": "وش آخر شي اشتريته بسبب تخفيض",
     "points": ["شي تحتاجه فعلاً؟ ولا غرّك العرض", "التخفيض ما ينفع لو ما تحتاج الغرض", "اشترِ بحاجة لا بإغراء"],
     "cta": "شاركنا آخر صفقة لك"},
    {"kicker": "ثقة", "title": "كيف تكشف رفع السعر قبل التخفيض",
     "points": ["صوّر سعر المنتج قبل العرض بأيام", "قارنه بسعر يوم التخفيض", "لو ارتفع ثم نزل فالخصم وهمي"],
     "cta": "نكشف الوهمي ونعرض الصادق"},
    {"kicker": "متاجر", "title": "متاجر العطور والعود بأكواد خصم",
     "points": ["تشكيلة عود وبخور سعودية", "عطور رجالية ونسائية", "أكواد توفّر لك بكل طلب"],
     "cta": "أكوادها بالرابط في البايو"},
    {"kicker": "خطوات", "title": "قارن سعر منتج بين متجرين بثواني",
     "points": ["انسخ اسم المنتج بالضبط", "ابحث عنه في متجرين", "احسب السعر مع الشحن والكود"],
     "cta": "أرخص سعر دايم يستاهل البحث"},
]
