...
# ════════════════════════════════════════════════════════════════════════════
    ...
    st.caption("سجل مسار العميل من داخل الستوري فقط — لو خرج من الستوري وراح للمتجر بطريق ثاني، الحركات ما تتحسب هنا.")
